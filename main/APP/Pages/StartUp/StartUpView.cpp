...
void StartupView::Create(lv_obj_t* root)
{
    ...
    lv_obj_set_style_text_font(label, ResourcePool::GetFont("bungee_28"), 0);
    lv_obj_set_style_text_color(label, lv_color_white(), 0);
    lv_label_set_text(label, LV_SYMBOL_GPS VERSION_FIRMWARE_NAME);
    lv_obj_center(label);
    ui.labelLogo = label;
